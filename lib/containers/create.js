  ...
  createEvent = () => {
    ...
    if (this.image && this.image.path) {
      ...
      RNS3.put(file, ENV.S3).then(s3response => {
        ...
        this.props
          .dispatch(Events.Create( data, this.props.account.token ))
      ...
      <View style={styles.wrapper}>
        <ScrollView>
          ...
          <View style={styles.event_more}>
            ...
            <TouchableOpacity style={styles.event_more_row} onPress={this.props.navigator.screen('CreatePlace',{onPlaceSelected: this.onPlaceSelected})}>
            ...
            <TouchableOpacity style={styles.event_more_row} onPress={this.props.navigator.screen('CreateDescription',  {onDescriptionAdded: this.onDescriptionAdded})} >
            ...
            <Button style={[styles.button_buy, this.state.loading? {opacity: 0.7}:null]} onPress={this.createEvent}>
