...
_this.removeBackButtonListener=_this.removeBackButtonListener.bind(_this);return _this;
}_createClass(AppNavigation,[{key:'render',value:function render()
...
configureScene:function configureScene(route){return _reactNative.Navigator.SceneConfigs.FloatFromRight;}}));
...
return _react2.default.createElement(Component,_extends({navigator:navigator},props));
