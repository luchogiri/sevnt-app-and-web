...
return(
_react2.default.createElement(_reactNative.TouchableOpacity,_extends({style:[styles.def,style]},attrs),
_react2.default.createElement(_text2.default,{style:[styles.label,textStyle]},props.children)));
