...
this.props.events.items.length?_react2.default.createElement(_core.View,{style:styles.imageContainer},
_react2.default.createElement(_core.Image,{style:styles.event_big_img,source:{uri:this.props.events.items[0].img}}),
_react2.default.createElement(_core.Text,{style:styles.categoria},(0,_i18n2.default)(this.props.events.items[0].category)),
_react2.default.createElement(_core.Text,{style:styles.titulo},this.props.events.items[0].name),
_react2.default.createElement(_core.Text,{style:styles.fecha},(0,_moment2.default)(this.props.events.items[0].start_date).format('DD'),' de ',(0,_i18n2.default)((0,_moment2.default)(this.props.events.items[0].start_date).format('MMMM'))),
_react2.default.createElement(_core.View,{style:styles.viewBtn},
_react2.default.createElement(_reactRouter.Link,{to:"/events/"+this.props.events.items[0]._id,style:styles.btn},_react2.default.createElement(_core.Text,{
style:styles.btnText},'Ver')))):
...
_react2.default.createElement(_core.View,{style:styles.listitem,key:this.props.events.items[3]._id},
_react2.default.createElement(_core.Image,{style:styles.event_img,source:{uri:this.props.events.items[3].img}}),
_react2.default.createElement(_core.View,{style:styles.event_text},
_react2.default.createElement(_core.Text,{style:styles.event_title},
this.props.events.items[3].name),

_react2.default.createElement(_core.Text,{style:styles.event_date},
(0,_moment2.default)(this.props.events.items[3].start_date).format('DD'),'de ',
(0,_i18n2.default)((0,_moment2.default)(this.props.events.items[3].start_date).format('MMMM')))),


_react2.default.createElement(_reactRouter.Link,{to:"/events/"+this.props.events.items[3]._id,style:styles.btn},_react2.default.createElement(_core.Text,{
style:styles.btnText},'Ver'))),


_react2.default.createElement(_core.View,{style:styles.listitem,key:this.props.events.items[2]._id},
_react2.default.createElement(_core.Image,{style:styles.event_img,source:{uri:this.props.events.items[2].img}}),
_react2.default.createElement(_core.View,{style:styles.event_text},
_react2.default.createElement(_core.Text,{style:styles.event_title},
this.props.events.items[2].name),

_react2.default.createElement(_core.Text,{style:styles.event_date},
(0,_moment2.default)(this.props.events.items[2].start_date).format('DD'),'de ',
(0,_i18n2.default)((0,_moment2.default)(this.props.events.items[2].start_date).format('MMMM')))),


_react2.default.createElement(_reactRouter.Link,{to:"/events/"+this.props.events.items[2]._id,style:styles.btn},_react2.default.createElement(_core.Text,{
style:styles.btnText},'Ver'))),


_react2.default.createElement(_core.View,{style:styles.listitem,key:this.props.events.items[1]._id},
_react2.default.createElement(_core.Image,{style:styles.event_img,source:{uri:this.props.events.items[1].img}}),
_react2.default.createElement(_core.View,{style:styles.event_text},
_react2.default.createElement(_core.Text,{style:styles.event_title},
this.props.events.items[1].name),

_react2.default.createElement(_core.Text,{style:styles.event_date},
(0,_moment2.default)(this.props.events.items[1].start_date).format('DD'),'de ',
(0,_i18n2.default)((0,_moment2.default)(this.props.events.items[1].start_date).format('MMMM')))),


_react2.default.createElement(_reactRouter.Link,{to:"/events/"+this.props.events.items[1]._id,style:styles.btn},_react2.default.createElement(_core.Text,{
style:styles.btnText},'Ver')))):
...
_react2.default.createElement(_core.Text,{style:styles.upcomingTitle},'Proximos Eventos'),
...
_react2.default.createElement(_core.Text,{style:styles.btnText},_react2.default.createElement(_reactRouter.Link,{to:"/events/"+item._id,style:styles.btn},'Ver'))));
...
viewBtn:{position:'absolute',top:350,left:40},
