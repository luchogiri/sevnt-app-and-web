...
Category=function(_Component){_inherits(Category,_Component);




function Category(props){_classCallCheck(this,Category);var _this=_possibleConstructorReturn(this,(Category.__proto__||Object.getPrototypeOf(Category)).call(this,
props));_this.
...
};_this.state={refreshing:false};return _this;}_createClass(Category,[{key:'render',value:function render()
...
_react2.default.createElement(_core.Text,{style:styles.upcomingTitle},'Eventos'),
...
}}]);return Category;}(_react.Component);



var Container=(0,_reactRedux.connect)(function(store){return store;})(Category);exports.default=
Container;
